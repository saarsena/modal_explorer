"use strict";var Oe=Object.create;var X=Object.defineProperty;var Be=Object.getOwnPropertyDescriptor;var Le=Object.getOwnPropertyNames;var He=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var Ve=(e,t)=>{for(var a in t)X(e,a,{get:t[a],enumerable:!0})},me=(e,t,a,c)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of Le(t))!ze.call(e,i)&&i!==a&&X(e,i,{get:()=>t[i],enumerable:!(c=Be(t,i))||c.enumerable});return e};var Fe=(e,t,a)=>(a=e!=null?Oe(He(e)):{},me(t||!e||!e.__esModule?X(a,"default",{value:e,enumerable:!0}):a,e)),qe=e=>me(X({},"__esModule",{value:!0}),e);var Et={};Ve(Et,{activate:()=>St});module.exports=qe(Et);var j=class he{constructor(t,a,c){this.handle=t,this.dataModel=a,this.objectRegistry=c}get parent(){let t=this.dataModel.getObjectCanonicalParent(this.handle);return t?this.objectRegistry.getObjectFromHandle(t,he):null}},H=(e,t,...a)=>new Promise((c,i)=>{e.withinTransaction(()=>t(...a,c,i))}),P=(e,t,a,c,...i)=>new Promise((m,s)=>{e.withinTransaction(()=>c(...i,r=>m(t.getObjectFromHandle(r,a)),s))}),F=class extends j{static className="Clip";get name(){return this.dataModel.clipGetName(this.handle)}set name(e){this.dataModel.withinTransaction(()=>{this.dataModel.clipSetName(this.handle,e)})}get startTime(){return this.dataModel.clipGetStartTime(this.handle)}get endTime(){return this.dataModel.clipGetEndTime(this.handle)}get duration(){return this.dataModel.clipGetEndTime(this.handle)-this.dataModel.clipGetStartTime(this.handle)}get startMarker(){return this.dataModel.clipGetStartMarker(this.handle)}get endMarker(){return this.dataModel.clipGetEndMarker(this.handle)}get looping(){return this.dataModel.clipGetLooping(this.handle)}set looping(e){this.dataModel.withinTransaction(()=>{this.dataModel.clipSetLooping(this.handle,e)})}get loopStart(){return this.dataModel.clipGetLoopStart(this.handle)}get loopEnd(){return this.dataModel.clipGetLoopEnd(this.handle)}get color(){return this.dataModel.clipGetColor(this.handle)}set color(e){this.dataModel.withinTransaction(()=>{this.dataModel.clipSetColor(this.handle,e)})}get muted(){return this.dataModel.clipGetMuted(this.handle)}set muted(e){this.dataModel.withinTransaction(()=>{this.dataModel.clipSetMuted(this.handle,e)})}},ee=class extends F{static className="AudioClip";get filePath(){return this.dataModel.audioclipGetFilePath(this.handle)}get warping(){return this.dataModel.audioclipGetWarping(this.handle)}set warping(e){this.dataModel.withinTransaction(()=>{this.dataModel.audioclipSetWarping(this.handle,e)})}get warpMode(){return this.dataModel.audioclipGetWarpMode(this.handle)}set warpMode(e){this.dataModel.withinTransaction(()=>{this.dataModel.audioclipSetWarpMode(this.handle,e)})}get warpMarkers(){return this.dataModel.audioclipGetWarpMarkers(this.handle)}},R=class extends F{static className="MidiClip";get notes(){return this.dataModel.midiclipGetNotes(this.handle)}set notes(e){this.dataModel.withinTransaction(()=>{this.dataModel.midiclipSetNotes(this.handle,e)})}},q=class extends j{static className="ClipSlot";get clip(){let e=this.dataModel.clipslotGetClip(this.handle);return e?this.objectRegistry.getObjectFromHandle(e,F):null}deleteClip(){return H(this.dataModel,this.dataModel.clipslotDeleteClip,this.handle)}createMidiClip(e){return P(this.dataModel,this.objectRegistry,R,this.dataModel.clipslotCreateMidiClip,this.handle,e)}createAudioClip(e){return P(this.dataModel,this.objectRegistry,ee,this.dataModel.clipslotCreateAudioClip,this.handle,{filePath:e.filePath,isWarped:e.isWarped,loopSettings:e.loopSettings})}},z=class extends j{static className="DeviceParameter";get name(){return this.dataModel.deviceParameterGetName(this.handle)}get min(){return this.dataModel.deviceParameterGetInternalMin(this.handle)}get max(){return this.dataModel.deviceParameterGetInternalMax(this.handle)}get isQuantized(){return this.dataModel.deviceParameterGetIsQuantized(this.handle)}get defaultValue(){return this.dataModel.deviceParameterGetDefaultValue(this.handle)}get valueItems(){return this.dataModel.deviceParameterGetValueItems(this.handle)}getValue(){return new Promise(e=>{this.dataModel.deviceParameterGetInternalValue(this.handle,e)})}setValue(e){return new Promise((t,a)=>{this.dataModel.withinTransaction(()=>{this.dataModel.deviceParameterSetInternalValue(this.handle,e,t,c=>a(new Error(c)))})})}},L=class extends j{static className="Device";get name(){return this.dataModel.deviceGetName(this.handle)}get parameters(){return this.dataModel.deviceGetParameters(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,z))}},se=class extends j{static className="TakeLane";get clips(){return this.dataModel.takelaneGetClips(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,F))}get name(){return this.dataModel.takelaneGetName(this.handle)}set name(e){this.dataModel.withinTransaction(()=>{this.dataModel.takelaneSetName(this.handle,e)})}createMidiClip(e,t){return P(this.dataModel,this.objectRegistry,R,this.dataModel.takelaneCreateMidiClip,this.handle,e,t)}createAudioClip(e){return P(this.dataModel,this.objectRegistry,ee,this.dataModel.takelaneCreateAudioClip,this.handle,{duration:e.duration,filePath:e.filePath,isWarped:e.isWarped,loopSettings:e.loopSettings,startTime:e.startTime})}},ue=class extends j{static className="MixerDevice";get volume(){return this.objectRegistry.getObjectFromHandle(this.dataModel.mixerdeviceGetVolume(this.handle),z)}get panning(){return this.objectRegistry.getObjectFromHandle(this.dataModel.mixerdeviceGetPanning(this.handle),z)}get sends(){return this.dataModel.mixerdeviceGetSends(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,z))}},V=class ge extends j{static className="Track";get name(){return this.dataModel.trackGetName(this.handle)}set name(t){this.dataModel.withinTransaction(()=>{this.dataModel.trackSetName(this.handle,t)})}get mute(){return this.dataModel.trackGetMute(this.handle)}set mute(t){this.dataModel.withinTransaction(()=>{this.dataModel.trackSetMute(this.handle,t)})}get solo(){return this.dataModel.trackGetSolo(this.handle)}set solo(t){this.dataModel.withinTransaction(()=>{this.dataModel.trackSetSolo(this.handle,t)})}get mutedViaSolo(){return this.dataModel.trackGetMutedViaSolo(this.handle)}get arm(){return this.dataModel.trackGetArm(this.handle)}set arm(t){this.dataModel.withinTransaction(()=>{this.dataModel.trackSetArm(this.handle,t)})}get clipSlots(){return this.dataModel.trackGetClipSlots(this.handle).map(t=>this.objectRegistry.getObjectFromHandle(t,q))}get takeLanes(){return this.dataModel.trackGetTakeLanes(this.handle).map(t=>this.objectRegistry.getObjectFromHandle(t,se))}get arrangementClips(){return this.dataModel.trackGetArrangementClips(this.handle).map(t=>this.objectRegistry.getObjectFromHandle(t,F))}get groupTrack(){let t=this.dataModel.trackGetGroupTrack(this.handle);return t?this.objectRegistry.getObjectFromHandle(t,ge):null}get devices(){return this.dataModel.trackGetDevices(this.handle).map(t=>this.objectRegistry.getObjectFromHandle(t,L))}get mixer(){return this.objectRegistry.getObjectFromHandle(this.dataModel.trackGetMixerDevice(this.handle),ue)}createTakeLane(){return P(this.dataModel,this.objectRegistry,se,this.dataModel.trackCreateTakeLane,this.handle)}insertDevice(t,a){return P(this.dataModel,this.objectRegistry,L,this.dataModel.trackInsertDevice,this.handle,t,BigInt(a))}deleteDevice(t){return H(this.dataModel,this.dataModel.trackDeleteDevice,this.handle,t.handle)}duplicateDevice(t){return P(this.dataModel,this.objectRegistry,L,this.dataModel.trackDuplicateDevice,this.handle,t.handle)}deleteClip(t){return H(this.dataModel,this.dataModel.trackDeleteClip,this.handle,t.handle)}clearClipsInRange(t,a){return H(this.dataModel,this.dataModel.trackClearClipsInRange,this.handle,t,a)}},be=class extends V{static className="AudioTrack";createAudioClip(e){return P(this.dataModel,this.objectRegistry,ee,this.dataModel.trackCreateAudioClip,this.handle,{duration:e.duration,filePath:e.filePath,isWarped:e.isWarped,loopSettings:e.loopSettings,startTime:e.startTime})}},ie=class extends j{static className="CuePoint";get time(){return this.dataModel.cuePointGetTime(this.handle)}get name(){return this.dataModel.cuePointGetName(this.handle)}set name(e){this.dataModel.withinTransaction(()=>{this.dataModel.cuePointSetName(this.handle,e)})}},K=class extends V{static className="MidiTrack";createMidiClip(e,t){return P(this.dataModel,this.objectRegistry,R,this.dataModel.trackCreateMidiClip,this.handle,e,t)}},Z=class extends j{static className="Scene";get name(){return this.dataModel.sceneGetName(this.handle)}set name(e){this.dataModel.withinTransaction(()=>{this.dataModel.sceneSetName(this.handle,e)})}get tempo(){return this.dataModel.sceneGetTempo(this.handle)}get signatureNumerator(){return this.dataModel.sceneGetSignatureNumerator(this.handle)}get signatureDenominator(){return this.dataModel.sceneGetSignatureDenominator(this.handle)}},fe=class extends j{static className="Song";get tracks(){return this.dataModel.songGetTracks(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,V))}get returnTracks(){return this.dataModel.songGetReturnTracks(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,V))}get mainTrack(){return this.objectRegistry.getObjectFromHandle(this.dataModel.songGetMainTrack(this.handle),V)}get scenes(){return this.dataModel.songGetScenes(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,Z))}get cuePoints(){return this.dataModel.songGetCuePoints(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,ie))}get tempo(){return this.dataModel.songGetTempo(this.handle)}set tempo(e){this.dataModel.withinTransaction(()=>{this.dataModel.songSetTempo(this.handle,e)})}get gridQuantization(){return this.dataModel.songGetGridQuantization(this.handle)}get gridIsTriplet(){return this.dataModel.songGetGridIsTriplet(this.handle)}get rootNote(){return Number(this.dataModel.songGetRootNote(this.handle))}get scaleName(){return this.dataModel.songGetScaleName(this.handle)}get scaleMode(){return this.dataModel.songGetScaleMode(this.handle)}get scaleIntervals(){return this.dataModel.songGetScaleIntervals(this.handle).map(Number)}createAudioTrack(){return P(this.dataModel,this.objectRegistry,be,this.dataModel.songCreateAudioTrack,this.handle)}createMidiTrack(){return P(this.dataModel,this.objectRegistry,K,this.dataModel.songCreateMidiTrack,this.handle)}createScene(e){return P(this.dataModel,this.objectRegistry,Z,this.dataModel.songCreateScene,this.handle,BigInt(e))}deleteTrack(e){return H(this.dataModel,this.dataModel.songDeleteTrack,this.handle,e.handle)}deleteScene(e){return H(this.dataModel,this.dataModel.songDeleteScene,this.handle,e.handle)}duplicateTrack(e){return P(this.dataModel,this.objectRegistry,V,this.dataModel.songDuplicateTrack,this.handle,e.handle)}duplicateScene(e){return P(this.dataModel,this.objectRegistry,Z,this.dataModel.songDuplicateScene,this.handle,e.handle)}createCuePoint(e){return P(this.dataModel,this.objectRegistry,ie,this.dataModel.songCreateCuePoint,this.handle,e)}deleteCuePoint(e){return H(this.dataModel,this.dataModel.songDeleteCuePoint,this.handle,e.handle)}},ve=class extends j{static className="Application";get song(){return this.objectRegistry.getObjectFromHandle(this.dataModel.rootGetSong(this.handle),fe)}},Ge=class{module;constructor(e){this.module=e}registerCommand(e,t){this.module.registerCommand(e,t)}executeCommand(e,...t){this.module.executeCommand(e,...t)}},ye=class extends j{static className="ChainMixerDevice";get volume(){return this.objectRegistry.getObjectFromHandle(this.dataModel.chainmixerdeviceGetVolume(this.handle),z)}get panning(){return this.objectRegistry.getObjectFromHandle(this.dataModel.chainmixerdeviceGetPanning(this.handle),z)}get sends(){return this.dataModel.chainmixerdeviceGetSends(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,z))}},Q=class extends j{static className="Chain";get devices(){return this.dataModel.chainGetDevices(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,L))}get mixer(){return this.objectRegistry.getObjectFromHandle(this.dataModel.chainGetMixerDevice(this.handle),ye)}insertDevice(e,t){return P(this.dataModel,this.objectRegistry,L,this.dataModel.chainInsertDevice,this.handle,e,BigInt(t))}deleteDevice(e){return H(this.dataModel,this.dataModel.chainDeleteDevice,this.handle,e.handle)}duplicateDevice(e){return P(this.dataModel,this.objectRegistry,L,this.dataModel.chainDuplicateDevice,this.handle,e.handle)}},xe=class extends Q{static className="DrumChain";get receivingNote(){return Number(this.dataModel.drumchainGetReceivingNote(this.handle))}set receivingNote(e){this.dataModel.withinTransaction(()=>{this.dataModel.drumchainSetReceivingNote(this.handle,BigInt(e))})}},we=class extends L{static className="RackDevice";get chains(){return this.dataModel.rackdeviceGetChains(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,Q))}insertChain(e){return P(this.dataModel,this.objectRegistry,Q,this.dataModel.rackdeviceInsertChain,this.handle,BigInt(e))}},We=class extends we{static className="DrumRackDevice";get chains(){return this.dataModel.rackdeviceGetChains(this.handle).map(e=>this.objectRegistry.getObjectFromHandle(e,xe))}},re=class extends j{static className="Sample";get filePath(){return this.dataModel.sampleGetFilePath(this.handle)}},Ke=class extends L{static className="Simpler";get sample(){let e=this.dataModel.simplerGetSample(this.handle);return e?this.objectRegistry.getObjectFromHandle(e,re):null}replaceSample(e){return P(this.dataModel,this.objectRegistry,re,this.dataModel.simplerReplaceSample,this.handle,e)}},Je=[ve,fe,be,K,V,ee,R,F,q,se,Ke,We,we,L,re,xe,Q,Z,ie,z,ue,ye],Ue=class{cache=new Map;dataModel;constructor(e){this.dataModel=e}getOrCreateObjectFromHandle(e){let t=this.cache.get(e.id);if(t)return t;let a=Je.find(i=>this.dataModel.getObjectIsOfClass(e,i.className));if(!a)throw new Error("Unknown object type");let c=new a(e,this.dataModel,this);return this.cache.set(e.id,c),c}getObjectFromHandle(e,t){let a=this.getOrCreateObjectFromHandle(e);if(!(a instanceof t))throw new Error("Object of incorrect type");return a}},Ye=class{module;constructor(e){this.module=e}get storageDirectory(){return this.module.storageDirectory}get tempDirectory(){return this.module.tempDirectory}get language(){return this.module.language}},Xe=class{module;constructor(e){this.module=e}renderPreFxAudio(e,t,a){return new Promise((c,i)=>{this.module.renderPreFxAudio(e.handle,{endTime:a,startTime:t},c,i)})}importIntoProject(e){return new Promise((t,a)=>{this.module.importIntoProject(e,t,a)})}},pe=(e,t)=>typeof t=="number"?{progress:t,text:e}:{text:e},Ze=class{module;constructor(e){this.module=e}registerContextMenuAction(e,t,a){return new Promise(c=>{this.module.registerContextMenuAction(e,t,a,i=>{c(()=>new Promise(m=>{i(m)}))})})}showModalDialog(e,t,a){return new Promise((c,i)=>{this.module.showModalDialog(e,t,a,c,i)})}withinProgressDialog(e,t,a){let c=new AbortController;return new Promise((i,m)=>{this.module.showProgressDialog(pe(e,t.progress),({update:s,close:r})=>{let n=(g,d)=>new Promise(l=>{s(pe(g,d),l)}),o=()=>new Promise(g=>{r(g)});a(n,c.signal).finally(o).then(i).catch(m)},()=>{c.abort()})})}},ke=(e,t)=>{let{commands:a,dataModel:c,environment:i,resources:m,ui:s}=e.initializeExtensionHost({apiVersion:t}),r=new Ue(c);return{application:r.getObjectFromHandle(c.getRoot(),ve),commands:new Ge(a),environment:new Ye(i),getObjectFromHandle:r.getObjectFromHandle.bind(r),resources:new Xe(m),ui:new Ze(s),withinTransaction:c.withinTransaction.bind(c)}};var Ce=require("node:child_process"),te=class{constructor(t,a="python"){this.cwd=t;this.pythonCmd=a}cwd;pythonCmd;proc=null;buffer="";pending=new Map;nextId=1;getProcess(){if(this.proc)return this.proc;let t=(0,Ce.spawn)(this.pythonCmd,["-u","-m","chordgen.server"],{cwd:this.cwd,stdio:["pipe","pipe","pipe"],env:{...process.env,PYTHONDONTWRITEBYTECODE:"1",PYTHONUTF8:"1"}});return t.stdout.on("data",a=>{this.buffer+=a.toString("utf8");let c;for(;(c=this.buffer.indexOf(`
`))!==-1;){let i=this.buffer.slice(0,c).trim();if(this.buffer=this.buffer.slice(c+1),!i)continue;let m;try{m=JSON.parse(i)}catch{continue}let s=m.id;if(s===void 0)continue;let r=this.pending.get(s);r&&(this.pending.delete(s),"error"in m?r.reject(new Error(String(m.error))):r.resolve(m.result))}}),t.stderr.on("data",a=>{console.error(`[chordgen] ${a.toString("utf8").trimEnd()}`)}),t.on("error",a=>{console.error(`[chordgen] failed to start: ${a.message}`),this.drainPending(a),this.proc=null}),t.on("exit",a=>{a!==0&&a!==null&&console.error(`[chordgen] process exited with code ${a}`),this.drainPending(new Error(`chordgen process exited (code ${a})`)),this.proc=null}),this.proc=t,t}drainPending(t){for(let[,a]of this.pending)a.reject(t);this.pending.clear()}send(t,a={}){let c=this.getProcess(),i=this.nextId++;return new Promise((m,s)=>{this.pending.set(i,{resolve:r=>m(r),reject:s}),c.stdin.write(JSON.stringify({op:t,id:i,...a})+`
`)})}dispose(){this.proc?.kill(),this.proc=null}};var $e=Fe(require("node:path"),1);var le=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
`;var J=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],_e={Major:"major",Minor:"natural_minor",Dorian:"dorian",Phrygian:"phrygian",Lydian:"lydian",Mixolydian:"mixolydian",Locrian:"locrian","Harmonic Minor":"harmonic_minor","Melodic Minor":"melodic_minor"},rt={C:0,"C#":1,Db:1,D:2,"D#":3,Eb:3,E:4,F:5,"F#":6,Gb:6,G:7,"G#":8,Ab:8,A:9,"A#":10,Bb:10,B:11},lt=[0,7,2,9,4,11,6,1,8,3,10,5],U=[0,2,4,5,7,9,11],ct=[0,2,3,5,7,8,10],dt=[0,2,3,5,7,9,10],mt=[0,1,3,5,7,8,10],pt=[0,2,4,6,7,9,11],ht=[0,2,4,5,7,9,10],ut=[0,1,3,5,6,8,10],gt=[0,2,3,5,7,8,11],bt=[0,2,3,5,7,9,11],ft=[0,2,4,7,9],vt=[0,3,5,7,10],yt=[0,3,5,6,7,10],Y={major:U,natural_minor:ct,dorian:dt,phrygian:mt,lydian:pt,mixolydian:ht,locrian:ut,harmonic_minor:gt,melodic_minor:bt,pentatonic_major:ft,pentatonic_minor:vt,blues:yt},xt={major:"major",natural_minor:"minor",dorian:"Dorian",phrygian:"Phrygian",lydian:"Lydian",mixolydian:"Mixolydian",locrian:"Locrian",harmonic_minor:"harmonic minor",melodic_minor:"melodic minor",pentatonic_major:"pentatonic major",pentatonic_minor:"pentatonic minor",blues:"blues"},Re=[{id:"major",label:"Major"},{id:"natural_minor",label:"Natural Minor"},{id:"dorian",label:"Dorian"},{id:"phrygian",label:"Phrygian"},{id:"lydian",label:"Lydian"},{id:"mixolydian",label:"Mixolydian"},{id:"locrian",label:"Locrian"},{id:"harmonic_minor",label:"Harmonic Minor"},{id:"melodic_minor",label:"Melodic Minor"},{id:"pentatonic_major",label:"Pentatonic Major"},{id:"pentatonic_minor",label:"Pentatonic Minor"},{id:"blues",label:"Blues"}];function W(e,t=.25){let a=new Map;for(let c of e){let i=Math.round(c.startTime/t)*t,m=Math.round(i*1e3),s=a.get(m);s?s.push(c.pitch):a.set(m,[c.pitch])}return a}function oe(e){return JSON.stringify(e).replace(/</g,"\\u003C").replace(/>/g,"\\u003E")}function wt(e,t,a){let c=t/100,i=a/100,m=c*Math.min(i,1-i),s=r=>{let n=(r+e/30)%12;return i-m*Math.max(Math.min(n-3,9-n,1),-1)};return Math.round(s(0)*255)<<16|Math.round(s(8)*255)<<8|Math.round(s(4)*255)}function ne(e){let t=e.match(/^([A-G][#b]?)\s+(.*)/);if(!t)return null;let a=rt[t[1]??""];if(a===void 0)return null;let c=/minor|min\b/i.test(t[2]??""),i=(lt[a]??0)*30;return wt(i,c?55:70,c?35:45)}async function G(e,t){let a=W(e),i=(await Promise.all([...a.entries()].map(([n,o])=>t.send("recognize_chord",{notes:o}).then(g=>({beatKey:n,r:g}))))).sort((n,o)=>n.beatKey-o.beatKey).flatMap(({r:n})=>{let o=n.matches[0];return o&&o.score>=.5?[o.chord.name]:[]}).filter((n,o,g)=>o===0||n!==g[o-1]);if(i.length>0){let o=(await t.send("analyze",{chord_names:i})).inferred_key;return{root:o.root,scale:o.scale,label:o.label}}let m=new Array(12).fill(0);for(let n of e){let o=n.pitch%12;m[o]=(m[o]??0)+1}let s=-1,r=null;for(let n=0;n<12;n++)for(let[o,g]of Object.entries(Y)){let d=0;for(let l of g)d+=m[(n+l)%12]??0;if(d>s){s=d;let l=J[n]??"C",p=xt[o]??o;r={root:n,scale:o,label:`${l} ${p}`}}}return r}function ce(e,t){let a=e%12;if(t.has(a))return e;for(let c=1;c<=6;c++){let i=t.has((a+c)%12),m=t.has((a-c+12)%12);if(i&&m||i)return e+c;if(m)return e-c}return e}function ae(e){let t=e.match(/^([A-G][#b]?)\s+(.+)$/);if(!t)return e;let a=t[1]??e,c=(t[2]??"").toLowerCase().trim();if(c==="major")return a;if(c==="minor"||c==="natural minor"||c==="natural_minor")return`${a}m`;if(c==="harmonic minor"||c==="harmonic_minor")return`${a}hm`;if(c==="melodic minor"||c==="melodic_minor")return`${a}mm`;let i=c.split(/[\s_]/)[0]??c;return`${a} ${i.slice(0,3)}`}function kt(e,t,a,c){return e===a&&t===c?"Same key":e===a?t?"Parallel major":"Parallel minor":!t&&c&&a===(e+9)%12?"Relative minor":t&&!c&&a===(e+3)%12?"Relative major":a===(e+7)%12?"Dominant (V)":a===(e+5)%12?"Subdominant (IV)":null}var Ct=/^[b#♭♯]?[ivIV]/;async function Mt(e,t,a,c){let i=async()=>(await e.send("parse_roman",{roman:t,key:a,scale:c})).chord,m=async()=>(await e.send("parse_chord",{name:t})).chord,[s,r]=Ct.test(t)?[i,m]:[m,i];try{return await s()}catch{try{return await r()}catch{throw new Error(`Couldn't parse "${t}" as a Roman numeral or chord name`)}}}async function Pe(e,t){let a=t.customProgression?.trim();if(!a){let{chords:i}=await e.send("progression",{key:t.key,scale:t.scale,template:t.template,sevenths:t.sevenths});return i}let c=a.split(/[\s,|]+/).filter(Boolean);return Promise.all(c.map(i=>Mt(e,i,t.key,t.scale)))}function De(e){return e.customProgression?.trim()||e.template}var It={halves:{span:4,hits:[{t:0,d:2,v:1},{t:2,d:2,v:.9}]},quarters:{span:4,hits:[{t:0,d:1,v:1},{t:1,d:1,v:.85},{t:2,d:1,v:.95},{t:3,d:1,v:.85}]},pump_8ths:{span:4,hits:[0,.5,1,1.5,2,2.5,3,3.5].map(e=>({t:e,d:.45,v:e%1===0?1:.8}))},swung_8ths:{span:4,hits:[0,1,2,3].flatMap(e=>[{t:e,d:.6,v:1},{t:e+.66,d:.3,v:.75}])},charleston:{span:4,hits:[{t:0,d:1.4,v:1},{t:1.5,d:2.4,v:.85}]},tresillo:{span:4,hits:[{t:0,d:1.4,v:1},{t:1.5,d:1.4,v:.85},{t:3,d:.9,v:.95}]},boom_chuck:{span:4,hits:[{t:0,d:.95,v:1},{t:1,d:.45,v:.75},{t:1.5,d:.45,v:.75},{t:2,d:.95,v:.95},{t:3,d:.45,v:.75},{t:3.5,d:.45,v:.75}]},syncopated:{span:4,hits:[{t:0,d:.7,v:1},{t:.75,d:.2,v:.7},{t:1,d:.45,v:.85},{t:1.5,d:1.4,v:.95},{t:3,d:.45,v:.85},{t:3.5,d:.45,v:.8}]},offbeats:{span:4,hits:[.5,1.5,2.5,3.5].map(e=>({t:e,d:.35,v:.95}))},arp_up_8ths:{span:4,arp:!0,hits:[0,.5,1,1.5,2,2.5,3,3.5].map(e=>({t:e,d:.5,v:e%1===0?.95:.8}))}},je=90;function de(e,t,a){let c=a?It[a]:void 0;if(!c)return e.flatMap((m,s)=>m.map(r=>({pitch:Math.max(0,Math.min(127,r)),startTime:s*t,duration:t*.95,velocity:je})));let i=t/c.span;return e.flatMap((m,s)=>{if(m.length===0)return[];let r=[...m].sort((n,o)=>n-o);return c.hits.flatMap((n,o)=>{let g=Math.max(1,Math.min(127,Math.round(je*n.v)));return(c.arp?[r[o%r.length]??60]:r).map(l=>({pitch:Math.max(0,Math.min(127,l)),startTime:s*t+n.t*i,duration:n.d*i,velocity:g}))})})}function St(e){let t=ke(e,"1.0.0"),a=process.env.COMPOSITION_AIDE_PATH??$e.join(__dirname,"..","engine"),c=process.env.PYTHON_CMD??(process.platform==="win32"?"python":"python3"),i=new te(a,c);i.send("list_ops").catch(()=>{}),t.commands.registerCommand("aide.generate",m=>{(async s=>{let r=s.selected_lanes.map(x=>t.getObjectFromHandle(x,j)).filter(x=>x instanceof K);if(!r.length){console.log("[composition-aide] No MIDI tracks in selection.");return}let n=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(le)}`,380,416),o;try{o=JSON.parse(n)}catch{return}if(!o)return;let g=s.time_selection_end-s.time_selection_start,d=await Pe(i,o),{voicings:l}=await i.send("voice_progression",{chords:d,strategy:o.voicing,octave:4}),p=g/d.length,u=`${De(o)} \u2014 ${o.keyName} ${o.scale.replace(/_/g," ")}`,b=de(l,p,o.rhythm);if(o.snapToScale){let x=Y[o.scale]??U,v=new Set(x.map(f=>(o.key+f)%12));b=b.map(f=>({...f,pitch:ce(f.pitch,v)}))}await Promise.all(r.map(async x=>{let v=await x.createMidiClip(s.time_selection_start,g);v.name=u,v.notes=b})),console.log(`[composition-aide] "${u}": ${d.map(x=>x.name).join(" \u2013 ")} (${p.toFixed(2)} beats/chord)`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("MidiTrack.ArrangementSelection","Generate Progression\u2026","aide.generate"),t.commands.registerCommand("aide.analyze",m=>{let s=async r=>{let n=t.getObjectFromHandle(r,R),o=n.notes;if(o.length===0){console.log("[composition-aide] Clip has no notes.");return}let g=W(o),l=(await Promise.all([...g.entries()].map(([C,_])=>i.send("recognize_chord",{notes:_}).then(B=>({beatKey:C,result:B}))))).sort((C,_)=>C.beatKey-_.beatKey).flatMap(({beatKey:C,result:_})=>{let B=_.matches[0];return!B||B.score<.5?[]:[{beat:C/1e3,name:B.chord.name,score:B.score,pitchClasses:B.chord.pitch_classes,root:B.chord.root,quality:B.chord.quality}]}).filter((C,_,B)=>_===0||C.name!==B[_-1]?.name);if(l.length===0){console.log("[composition-aide] Could not identify any chords in this clip.");return}let p=l.map(C=>C.name),u=await i.send("analyze",{chord_names:p}),b={clipName:n.name||"(unnamed clip)",noteCount:o.length,inferredKey:u.inferred_key.label,scaleRoot:u.inferred_key.root,scaleIntervals:[...Y[u.inferred_key.scale]??U],chords:p.map((C,_)=>({beat:l[_]?.beat??0,name:C,roman:u.roman_labels[_]??C,tension:u.tension[_]??0,score:l[_]?.score??0,pitchClasses:l[_]?.pitchClasses??[],root:l[_]?.root??0,quality:l[_]?.quality??"major"})),substitutions:u.substitutions.slice(0,5).map(C=>({position:C.position,original:C.original.name,replacement:C.replacement.name,rationale:C.rationale})),summary:u.summary},x=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(Me.replace("__ANALYSIS_JSON__",oe(b)))}`,520,560);console.log(`[composition-aide] Analyzed "${b.clipName}": ${b.inferredKey} \u2014 ${p.join(" \u2013 ")}`);let v;try{v=JSON.parse(x)}catch{return}if(!v||v.action!=="substitute")return;let{position:f,original:w,replacement:S}=v,A=l[f];if(!A){console.error(`[composition-aide] Substitution position ${f} out of range.`);return}let I=l[f+1],M=A.beat,E=n.notes,h=Math.max(M+4,...E.map(C=>C.startTime+C.duration)),y=I?.beat??h,k=E.filter(C=>C.startTime>=M-.01&&C.startTime<y-.01),T=k.length>0?Math.round(k.reduce((C,_)=>C+_.pitch,0)/k.length):60,D=Math.max(3,Math.min(6,Math.floor(T/12)-1)),O=await i.send("voicings",{name:S,octave:D}),N=k.length>0?k.reduce((C,_)=>C+_.duration,0)/k.length:(y-M)*.95,$=O.close.map(C=>({pitch:Math.max(0,Math.min(127,C)),startTime:M,duration:N,velocity:90}));n.notes=[...E.filter(C=>C.startTime<M-.01||C.startTime>=y-.01),...$],console.log(`[composition-aide] Substituted: ${w} \u2192 ${S} at beat ${M.toFixed(2)} (octave ${D})`),await s(r)};s(m).catch(r=>console.error(r))}),t.ui.registerContextMenuAction("MidiClip","Analyze Harmony\u2026","aide.analyze"),t.commands.registerCommand("aide.chordPalette",m=>{(async s=>{let r=t.getObjectFromHandle(s,q),n=t.application.song,o=n?.rootNote??0,g=n?.scaleName??"Major",d=_e[g]??"major",l=await Promise.all(Re.flatMap(({id:y})=>[i.send("diatonic",{key:o,scale:y,sevenths:!1}).then(k=>({id:y,sevenths:!1,chords:k.chords})),i.send("diatonic",{key:o,scale:y,sevenths:!0}).then(k=>({id:y,sevenths:!0,chords:k.chords}))])),p={};for(let{id:y,sevenths:k,chords:T}of l)p[y]||(p[y]={triads:[],sevenths:[],intervals:Y[y]??U}),k?p[y].sevenths=T:p[y].triads=T;let u={keyRoot:o,keyName:J[o]??"C",defaultScale:d,scaleOptions:Re,scales:p},b=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(Ie.replace("__PALETTE_JSON__",oe(u)))}`,510,296),x;try{x=JSON.parse(b)}catch{return}if(!x||x.action!=="insert")return;let{chordName:v,length:f,voicing:w,octave:S,selectedScale:A}=x,E=(await i.send("voicings",{name:v,octave:S}))[w].map(y=>({pitch:Math.max(0,Math.min(127,y)),startTime:0,duration:f*.95,velocity:90})),h=r.clip;if(h instanceof R)h.name=v,h.notes=E;else{let y=await r.createMidiClip(f);y.name=v,y.notes=E}console.log(`[composition-aide] Inserted ${v} (${w}, oct ${S}, ${f} beats) \u2014 ${u.keyName} ${A}`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("ClipSlot","Insert Chord\u2026","aide.chordPalette"),t.commands.registerCommand("aide.sessionMap",m=>{(async s=>{let r=t.application.song;if(!r)return;let n=r.tracks,g=r.scenes.map(I=>I.name),d=[];for(let I=0;I<n.length;I++){let M=n[I];if(!M)continue;let E=M.clipSlots;for(let h=0;h<E.length;h++){let y=E[h];if(!y)continue;let k=y.clip;if(!(k instanceof R))continue;let T=k.notes;T.length!==0&&d.push({trackIndex:I,trackName:M.name,sceneIndex:h,notes:T,clipName:k.name||"(unnamed)"})}}let l=d.length;if(l===0){console.log("[composition-aide] No MIDI clips with notes found in session.");return}let u=d.reduce((I,M)=>Math.max(I,M.sceneIndex),0)+1,b=[];await t.ui.withinProgressDialog(`Analyzing session \u2014 ${l} clips\u2026`,{progress:0},async(I,M)=>{let E=0;await Promise.all(d.map(async h=>{if(M.aborted)return;let y=null,k=0;try{let T=W(h.notes),O=(await Promise.all([...T.entries()].map(([N,$])=>i.send("recognize_chord",{notes:$}).then(C=>({beatKey:N,r:C}))))).sort((N,$)=>N.beatKey-$.beatKey).flatMap(({beatKey:N,r:$})=>{let C=$.matches[0];return!C||C.score<.5?[]:[{beat:N/1e3,name:C.chord.name}]}).filter((N,$,C)=>$===0||N.name!==C[$-1]?.name);if(O.length>0){let N=await i.send("analyze",{chord_names:O.map($=>$.name)});y=N.inferred_key.label,k=N.inferred_key.score}}catch(T){console.error(`[composition-aide] Could not analyze ${h.clipName}:`,T)}b.push({...h,key:y,score:k}),E++,await I(`${E} / ${l} clips\u2026`,Math.round(E/l*100))}))});let x=new Map;for(let I of b)I.key&&x.set(I.key,(x.get(I.key)??0)+1);let v=null,f=0;for(let[I,M]of x)M>f&&(f=M,v=I);let S=[...new Set(b.map(I=>I.trackIndex))].sort((I,M)=>I-M).map(I=>{let M=b.find(h=>h.trackIndex===I)?.trackName??`Track ${I+1}`,E=Array(u).fill(null);for(let h of b.filter(y=>y.trackIndex===I))E[h.sceneIndex]={clipName:h.clipName,key:h.key,score:h.score};return{name:M,clips:E}}),A={dominantKey:v,sceneCount:u,sceneNames:g.slice(0,u),totalMidiClips:l,analyzedClips:b.filter(I=>I.key!==null).length,tracks:S};await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(Se.replace("__SESSION_JSON__",oe(A)))}`,680,480),console.log(`[composition-aide] Session map: ${A.analyzedClips}/${l} clips`+(v?` \u2014 dominant key: ${v}`:""))})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("Scene","Map Session Keys\u2026","aide.sessionMap"),t.commands.registerCommand("aide.colorByKey",m=>{(async s=>{let r=t.application.song;if(!r)return;let n=[];for(let g of r.tracks)for(let d of g.clipSlots){let l=d.clip;if(!(l instanceof R))continue;let p=l.notes;p.length!==0&&n.push({clip:l,notes:p,clipName:l.name||"(unnamed)"})}if(n.length===0){console.log("[composition-aide] No MIDI clips with notes found.");return}let o=0;await t.ui.withinProgressDialog(`Coloring ${n.length} clips by key\u2026`,{progress:0},async(g,d)=>{let l=0;await Promise.all(n.map(async p=>{if(!d.aborted){try{let u=W(p.notes),x=(await Promise.all([...u.entries()].map(([v,f])=>i.send("recognize_chord",{notes:f}).then(w=>({beatKey:v,r:w}))))).sort((v,f)=>v.beatKey-f.beatKey).flatMap(({r:v})=>{let f=v.matches[0];return f&&f.score>=.5?[f.chord.name]:[]}).filter((v,f,w)=>f===0||v!==w[f-1]);if(x.length>0){let v=await i.send("analyze",{chord_names:x}),f=ne(v.inferred_key.label);f!==null&&(p.clip.color=f,o++)}}catch(u){console.error(`[composition-aide] Could not color "${p.clipName}":`,u)}l++,await g(`${l} / ${n.length} clips\u2026`,Math.round(l/n.length*100))}}))}),console.log(`[composition-aide] Colored ${o} / ${n.length} clips by key.`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("Scene","Color Clips by Key","aide.colorByKey"),t.commands.registerCommand("aide.generateInClip",m=>{(async s=>{let r=t.getObjectFromHandle(s,R),n=r.looping?r.loopEnd-r.loopStart:r.duration,o=n>0?n:8,g=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(le)}`,380,416),d;try{d=JSON.parse(g)}catch{return}if(!d)return;let l=await Pe(i,d),{voicings:p}=await i.send("voice_progression",{chords:l,strategy:d.voicing,octave:4}),u=o/l.length,b=de(p,u,d.rhythm);if(d.snapToScale){let x=Y[d.scale]??U,v=new Set(x.map(f=>(d.key+f)%12));b=b.map(f=>({...f,pitch:ce(f.pitch,v)}))}r.notes=b,r.name=`${De(d)} \u2014 ${d.keyName} ${d.scale.replace(/_/g," ")}`,console.log(`[composition-aide] Generated "${r.name}": ${l.map(x=>x.name).join(" \u2013 ")} (${u.toFixed(2)} beats/chord)`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("MidiClip","Fill Clip with Progression\u2026","aide.generateInClip"),t.commands.registerCommand("aide.voiceLead",m=>{(async s=>{let r=t.getObjectFromHandle(s,R),n=r.notes;if(n.length===0){console.log("[composition-aide] Clip has no notes.");return}let o=W(n),d=(await Promise.all([...o.entries()].map(([w,S])=>i.send("recognize_chord",{notes:S}).then(A=>({beatKey:w,r:A}))))).sort((w,S)=>w.beatKey-S.beatKey).flatMap(({beatKey:w,r:S})=>{let A=S.matches[0];return!A||A.score<.5?[]:[{beat:w/1e3,name:A.chord.name}]}).filter((w,S,A)=>S===0||w.name!==A[S-1]?.name);if(d.length===0){console.log("[composition-aide] No chords identified in clip.");return}let l=Math.round(n.reduce((w,S)=>w+S.pitch,0)/n.length),p=Math.max(3,Math.min(6,Math.floor(l/12)-1)),{voicings:u}=await i.send("voice_progression",{chords:d.map(w=>w.name),strategy:"smooth",octave:p}),b=new Map;for(let w of n){let S=Math.round(w.startTime/.25)*.25,A=Math.round(S*1e3),I=b.get(A)??[];I.push(w),b.set(A,I)}let x=new Set(d.map(w=>Math.round(w.beat*1e3))),v=[];for(let w=0;w<d.length;w++){let S=d[w],A=u[w]??[];if(!S||A.length===0)continue;let I=Math.round(S.beat*1e3),M=b.get(I)??[],E=M.length>0?M.reduce((y,k)=>y+k.duration,0)/M.length:2,h=M.length>0?Math.round(M.reduce((y,k)=>y+(k.velocity??90),0)/M.length):90;for(let y of A)v.push({pitch:Math.max(0,Math.min(127,y)),startTime:S.beat,duration:E,velocity:h})}let f=n.filter(w=>{let S=Math.round(Math.round(w.startTime/.25)*.25*1e3);return!x.has(S)});r.notes=[...f,...v],console.log(`[composition-aide] Voice-led "${r.name||"(unnamed)"}": ${d.length} chords, octave ${p}`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("MidiClip","Optimize Voice Leading","aide.voiceLead"),t.commands.registerCommand("aide.snapToKey",m=>{(async s=>{let r=t.getObjectFromHandle(s,R),n=r.notes;if(n.length===0){console.log("[composition-aide] Clip has no notes.");return}let o=await G(n,i);if(!o){console.log("[composition-aide] Could not determine key for this clip.");return}let g=await i.send("scale_info",{key:o.root,scale:o.scale}),d=new Set(g.notes),l=n.filter(u=>d.has(u.pitch%12)),p=n.length-l.length;r.notes=l,console.log(`[composition-aide] Snapped "${r.name||"(unnamed)"}" to ${o.label}: removed ${p} out-of-key notes, kept ${l.length}`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("MidiClip","Snap to Key","aide.snapToKey"),t.commands.registerCommand("aide.batchTranspose",m=>{(async s=>{let r=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(Ee)}`,300,200),n;try{n=JSON.parse(r)}catch{return}if(!n||n.action!=="transpose")return;let{semitones:o}=n;if(o===0)return;let g=0;for(let d of s.selected_clip_slots){let p=t.getObjectFromHandle(d,q).clip;if(!(p instanceof R))continue;let u=p.notes;u.length!==0&&(p.notes=u.map(b=>({pitch:Math.max(0,Math.min(127,b.pitch+o)),startTime:b.startTime,duration:b.duration,velocity:b.velocity??90})),g++)}console.log(`[composition-aide] Transposed ${g} clips ${o>0?"+":""}${o} semitones`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("ClipSlotSelection","Transpose Selected Clips\u2026","aide.batchTranspose"),t.commands.registerCommand("aide.findCompatible",m=>{(async s=>{let r=t.getObjectFromHandle(s,R),n=r.notes;if(n.length===0){console.log("[composition-aide] Clip has no notes.");return}let o=await G(n,i);if(!o){console.log("[composition-aide] Could not determine key for reference clip.");return}let g=t.application.song;if(!g)return;let d=/minor|min\b/i.test(o.scale),l=[];for(let h of g.tracks)for(let y of h.clipSlots){let k=y.clip;if(!(k instanceof R))continue;let T=k.notes;T.length!==0&&l.push({trackName:h.name,clip:k,notes:T})}let p=[];await t.ui.withinProgressDialog("Scanning session for compatible clips\u2026",{progress:0},async(h,y)=>{let k=0;await Promise.all(l.map(async T=>{if(!y.aborted){try{let D=await G(T.notes,i);if(D){let O=/minor|min\b/i.test(D.scale),N=kt(o.root,d,D.root,O);N&&p.push({trackName:T.trackName,clipName:T.clip.name||"(unnamed)",key:D.label,compatibility:N,color:ne(D.label)??4473924})}}catch(D){console.error(`[composition-aide] Error scanning "${T.clip.name}":`,D)}k++,await h(`${k} / ${l.length} clips\u2026`,Math.round(k/l.length*100))}}))});let u=["Same key","Relative minor","Relative major","Parallel major","Parallel minor","Dominant (V)","Subdominant (IV)"];p.sort((h,y)=>{let k=u.indexOf(h.compatibility),T=u.indexOf(y.compatibility);return(k===-1?99:k)-(T===-1?99:T)});let b=[{root:o.root,scale:o.scale,label:o.label,relationship:"Same key"}],x=d?(o.root+3)%12:(o.root+9)%12;b.push({root:x,scale:d?"major":"natural_minor",label:`${J[x]??"C"} ${d?"major":"minor"}`,relationship:d?"Relative major":"Relative minor"});let v=(o.root+7)%12;b.push({root:v,scale:o.scale,label:`${J[v]??"C"} ${d?"minor":"major"}`,relationship:"Dominant (V)"});let f=(o.root+5)%12;b.push({root:f,scale:o.scale,label:`${J[f]??"C"} ${d?"minor":"major"}`,relationship:"Subdominant (IV)"});let w=["I-V-vi-IV","I-IV-V-I","ii-V-I"],S=[];await Promise.all(b.flatMap((h,y)=>(y===0?w:w.slice(0,2)).map(async T=>{try{let D=await i.send("progression",{key:h.root,scale:h.scale,template:T,sevenths:!1});S.push({relationship:h.relationship,keyLabel:h.label,template:T,chords:D.chords.map(O=>O.name),color:ne(h.label)??4473924})}catch{}})));let A=["Same key","Relative minor","Relative major","Dominant (V)","Subdominant (IV)"];S.sort((h,y)=>{let k=A.indexOf(h.relationship),T=A.indexOf(y.relationship);return(k===-1?99:k)-(T===-1?99:T)});let I={refClipName:r.name||"(unnamed)",refKey:o.label,results:p,suggestions:S},M=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(Te.replace("__COMPATIBLE_JSON__",oe(I)))}`,620,560),E=null;try{let h=JSON.parse(M);h&&typeof h.action=="string"&&(E=h)}catch{}if(E?.action==="writeProgression"){let h=E.suggestion,y=null;e:for(let k of g.tracks)if(k instanceof K){for(let T of k.clipSlots)if(T.clip===null){y=T;break e}}if(!y)console.log("[composition-aide] No empty MIDI slot found \u2014 add an empty slot to a MIDI track.");else{let T=h.chords.length*2,D=[];for(let N=0;N<h.chords.length;N++)try{let $=await i.send("voicings",{name:h.chords[N],octave:4});for(let C of $.close??[])D.push({pitch:Math.max(0,Math.min(127,C)),startTime:N*2,duration:2*.95,velocity:90})}catch{console.warn(`[composition-aide] Could not voice chord "${h.chords[N]}"`)}let O=await y.createMidiClip(T);O.notes=D,O.name=`${h.keyLabel} \xB7 ${h.template}`,O.color=h.color,console.log(`[composition-aide] Wrote "${O.name}" (${h.chords.join(" \u2013 ")}) to empty slot`)}}console.log(`[composition-aide] Found ${p.length} compatible clips for "${I.refClipName}" (${o.label})`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("MidiClip","Find Compatible Clips\u2026","aide.findCompatible"),t.commands.registerCommand("aide.snapToScale",m=>{(async s=>{let r=t.getObjectFromHandle(s,R),n=r.notes;if(n.length===0){console.log("[composition-aide] Clip has no notes.");return}let o=await G(n,i);if(!o){console.log("[composition-aide] Could not determine key for this clip.");return}let g=await i.send("scale_info",{key:o.root,scale:o.scale}),d=new Set(g.notes),l=0,p=n.map(u=>{let b=ce(u.pitch,d);return b!==u.pitch&&l++,{...u,pitch:b}});r.notes=p,console.log(`[composition-aide] Snapped "${r.name||"(unnamed)"}" to ${o.label}: ${l} notes adjusted, ${n.length-l} already in scale`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("MidiClip","Snap Notes to Scale","aide.snapToScale"),t.commands.registerCommand("aide.labelClipKey",m=>{(async s=>{let r=t.getObjectFromHandle(s,R),n=r.notes;if(n.length===0){console.log("[composition-aide] Clip has no notes.");return}let o=await G(n,i);if(!o){console.log("[composition-aide] Could not determine key for this clip.");return}let g=(r.name||"").replace(/ \[[^\]]*\]$/,"").trim(),d=g.length>0?`${g} [${ae(o.label)}]`:`[${ae(o.label)}]`;r.name=d,console.log(`[composition-aide] Labeled clip: "${d}" (${o.label})`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("MidiClip","Label with Key","aide.labelClipKey"),t.commands.registerCommand("aide.labelAllKeys",m=>{(async s=>{let r=t.application.song;if(!r)return;let n=[];for(let g of r.tracks)for(let d of g.clipSlots){let l=d.clip;if(!(l instanceof R))continue;let p=l.notes;p.length!==0&&n.push({clip:l,notes:p})}if(n.length===0){console.log("[composition-aide] No MIDI clips with notes found.");return}let o=0;await t.ui.withinProgressDialog(`Labeling ${n.length} clips\u2026`,{progress:0},async(g,d)=>{let l=0;await Promise.all(n.map(async p=>{if(!d.aborted){try{let u=await G(p.notes,i);if(u){let b=(p.clip.name||"").replace(/ \[[^\]]*\]$/,"").trim();p.clip.name=b.length>0?`${b} [${ae(u.label)}]`:`[${ae(u.label)}]`,o++}}catch(u){console.error(`[composition-aide] Could not label "${p.clip.name}":`,u)}l++,await g(`${l} / ${n.length} clips\u2026`,Math.round(l/n.length*100))}}))}),console.log(`[composition-aide] Labeled ${o} / ${n.length} clips with key.`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("Scene","Label All Clips with Key","aide.labelAllKeys"),t.commands.registerCommand("aide.transposeSession",m=>{(async s=>{let r=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(Ae)}`,300,250),n;try{n=JSON.parse(r)}catch{return}if(!n||n.action!=="transpose")return;let{semitones:o,recolor:g}=n,d=t.application.song;if(!d)return;let l=[];for(let u of d.tracks)for(let b of u.clipSlots){let x=b.clip;x instanceof R&&l.push({clip:x,clipName:x.name||"(unnamed)"})}if(l.length===0){console.log("[composition-aide] No MIDI clips found in session.");return}let p=g?`Transposing + recoloring ${l.length} clips\u2026`:`Transposing ${l.length} clips\u2026`;await t.ui.withinProgressDialog(p,{progress:0},async(u,b)=>{if(o!==0){let x=0;for(let v of l){if(b.aborted)return;let f=v.clip.notes;f.length>0&&(v.clip.notes=f.map(w=>({...w,pitch:Math.max(0,Math.min(127,w.pitch+o))}))),x++,await u(`Transposing: ${x} / ${l.length}\u2026`,Math.round(g?x/l.length*50:x/l.length*100))}}if(g&&!b.aborted){let x=0,v=0;await Promise.all(l.map(async f=>{if(!b.aborted){try{let w=f.clip.notes;if(w.length===0)return;let S=W(w),I=(await Promise.all([...S.entries()].map(([M,E])=>i.send("recognize_chord",{notes:E}).then(h=>({beatKey:M,r:h}))))).sort((M,E)=>M.beatKey-E.beatKey).flatMap(({r:M})=>{let E=M.matches[0];return E&&E.score>=.5?[E.chord.name]:[]}).filter((M,E,h)=>E===0||M!==h[E-1]);if(I.length>0){let M=await i.send("analyze",{chord_names:I}),E=ne(M.inferred_key.label);E!==null&&(f.clip.color=E,x++)}}catch{}v++,await u(`Recoloring: ${v} / ${l.length}\u2026`,50+Math.round(v/l.length*50))}})),console.log(`[composition-aide] Session transposed ${o>0?"+":""}${o} semitones, ${x} clips recolored.`)}else console.log(`[composition-aide] Session transposed ${o>0?"+":""}${o} semitones.`)})})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("Scene","Transpose Session\u2026","aide.transposeSession"),t.commands.registerCommand("aide.theoryMachine",m=>{(async s=>{let r=t.getObjectFromHandle(s,q),n=t.application.song,o=n?.rootNote??0,g=_e[n?.scaleName??"Major"]??"major",d=Ne.replace("</head>",`<script>window._INIT={key:${o},scale:${JSON.stringify(g)}};</script></head>`),l=await t.ui.showModalDialog(`data:text/html,${encodeURIComponent(d)}`,1e3,700),p;try{p=JSON.parse(l)}catch{return}if(!p||p.action!=="writeClip")return;let{chords:u,beatsPerChord:b,totalBeats:x}=p,v=de(u.map(S=>S.notes),b,p.rhythm),f=u.map(S=>S.name).join(" \u2013 "),w=r.clip;if(w instanceof R)w.notes=v,w.name=f;else{let S=await r.createMidiClip(x);S.notes=v,S.name=f}console.log(`[composition-aide] Theory Machine: wrote ${u.length} chords (${b} beats each) \u2014 "${f}"`)})(m).catch(s=>console.error(s))}),t.ui.registerContextMenuAction("ClipSlot","Modal Explorer\u2026","aide.theoryMachine")}0&&(module.exports={activate});
